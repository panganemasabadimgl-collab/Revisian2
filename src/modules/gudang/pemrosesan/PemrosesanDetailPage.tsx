...
/**
 * PEMROSESAN DETAIL PAGE
 * Tampilan detail data pemrosesan (Read Only).
 */
export const PemrosesanDetailPage: React.FC = () => {
  ...
  return (
    <DetailShell
      ...
      id="pemrosesan-detail-shell"
      onBack={() => navigate('/gudang/pemrosesan')}
    >
...
export default PemrosesanDetailPage;
